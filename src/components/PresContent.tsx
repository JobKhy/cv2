    ...
    <Container id="home">
      <Left>
        ...
        <div className="w-[492px] m-0 text-lg font-light max-w-[100%]">
          Junior FrontEnd developer who wants to improve his knowledges and gain
          work experience, 1 year of experience in React, Next.js, TypeScript,
          and JavaScript.
        </div>
      </Left>
      <More>
        <a href="#projects">Take a look at my projects</a>
        <Finger className=" text-center text-3xl">👇</Finger>
      </More>
      <Right>
